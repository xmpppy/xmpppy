...
not obvious what is activated, and when flag_show is given, output is not
really meaningfull.

This Debug class can either be initialized and used on app level, or used independently
...
DBG_MULTI = [ DBG_INIT, DBG_CONNECTION ]
  ...
  use this class instead if you globally want to disable debugging
"""
...
class Debug:
    def __init__(self,
                 ...
                 active_flags=None,
                 #
                 # Log file should be file object or file name
                 #
                 log_file=sys.stderr,
                 #
                 # prefix and suffix can either be set globally or per call.
                 ...
                 time_stamp=0,
                 #
                 # flag_show should normally be of, but can be turned on to get a
                 ...
                 # recommended values would be '-' or ':', but any string goes
                 #
                 flag_show=None,
                 #
                 # If you do not want to validate flags on each call to
                 # show(), set this to 0
                 #
                 validate_flags=1,
                 #
                 # If you do not want the welcome message, set to 0
        ...
        self.flag_show = None  # must be initialized after possible welcome
    ...
    def show(self, msg, flag=None, prefix=None, sufix=None, lf=0):
        ...
        if self.flag_show:
            if flag:
                ...
                # do not print "None", just show the separator
    ...
    def _as_one_list(self, items):
        ...
        This code organises lst and removes dupes
        """
